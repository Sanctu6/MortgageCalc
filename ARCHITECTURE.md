...
Користувач може вказати середню річну інфляцію гривні. Калькулятор дисконтує майбутні відсотки та страхові платежі до поточної вартості й показує її окремо від номінальної переплати.
