...
Генерує повний графік амортизації з обліком страховки, змінюючогося залишку та переходу ставки після 120-го місяця.

### Ступінчаста ставка

У розрахунках використовується 7% річних протягом перших 120 місяців і 10% після цього. У режимі розрахунку за строком щомісячний платіж визначається з урахуванням обох періодів.
